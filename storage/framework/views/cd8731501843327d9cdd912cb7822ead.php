        ...
        <div class="flex justify-between h-24">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <img src="<?php echo e(asset('images/chamo-logo2.png')); ?>" alt="Los Chamos Logo" class="block h-20 w-auto fill-current text-chamos-marron-oscuro dark:text-gray-200">
                    </a>
                </div>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('pedidos.index'),'active' => request()->routeIs('pedidos.index'),'class' => 'text-white hover:text-chamos-cafe']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('pedidos.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('pedidos.index')),'class' => 'text-white hover:text-chamos-cafe']); ?>

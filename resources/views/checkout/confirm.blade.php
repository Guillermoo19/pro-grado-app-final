                ...
                <form action="{{ route('checkout.upload_proof', $pedido->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="delivery_fields" class="{{ old('tipo_entrega', $pedido->tipo_entrega ?? '') == 'domicilio' ? '' : 'hidden' }}">
                        <div class="mb-4">
                            ...
                            <input type="text" name="direccion_entrega" id="direccion_entrega" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('direccion_entrega', $pedido->direccion_entrega ?? '') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="telefono_contacto" id="telefono_contacto" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('telefono_contacto', $pedido->telefono_contacto ?? '') }}">

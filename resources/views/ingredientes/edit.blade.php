                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('ingredientes.update', $ingrediente->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('descripcion', $ingrediente->descripcion) }}</textarea>

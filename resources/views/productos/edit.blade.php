                    ...
                    <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($producto->imagen)
                                <div class="mt-2 mb-2">
                                    <p>Imagen actual:</p>
                                    <img src="{{ asset($producto->imagen) }}" alt="Imagen actual del producto" class="w-32 h-32 object-cover rounded-md shadow-sm">
                                </div>
                            @endif
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">JPG, PNG, GIF o SVG (Máx. 2MB). Deja vacío para mantener la imagen actual.</p>

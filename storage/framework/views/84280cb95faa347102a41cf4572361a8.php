                                    ...
                                    <table class="min-w-full leading-normal">
                                        ...
                                        <tbody>
                                            <?php $__empty_1 = true; $__currentLoopData = $pedidosPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?php echo e($pedido->id); ?></td>
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"><?php echo e($pedido->user->name ?? 'N/A'); ?></td>
                                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">$<?php echo e(number_format($pedido->total, 2)); ?></td>
                                                    <td class="py-4 px-6">

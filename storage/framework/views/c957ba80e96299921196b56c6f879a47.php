...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('header', null, []); ?> 
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <?php echo e(__('Gestión de Ingredientes')); ?>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-2xl font-bold mb-6 text-chamos-marron-oscuro"><?php echo e(__('Lista de Ingredientes')); ?></h3>
                        ...
                        <?php if($ingredientes->isEmpty()): ?>
                            <p class="text-gray-600"><?php echo e(__('No hay ingredientes registrados en el sistema.')); ?></p>
                        <?php else: ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $ingredientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingrediente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="bg-white border-b hover:bg-gray-50">
                                                ...
                                                <td class="py-4 px-6">
                                                    <?php echo e($ingrediente->descripcion ?? 'N/A'); ?>
...
<?php endif; ?>
    <?php /**PATH E:\Proyecto de Grado\Laravel\pro-grado-app-final\resources\views\admin\ingredientes\index.blade.php ENDPATH**/ ?>
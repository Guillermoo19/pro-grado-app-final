            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-2xl font-bold mb-6 text-chamos-marron-oscuro"><?php echo e(__('Formulario de Nuevo Producto')); ?></h3>

                        <form method="POST" action="<?php echo e(route('admin.productos.store')); ?>" enctype="multipart/form-data" class="space-y-6">
                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <input id="nombre" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="nombre" value="<?php echo e(old('nombre')); ?>" required autofocus />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea id="descripcion" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="descripcion"><?php echo e(old('descripcion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="precio" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" step="0.01" min="0" name="precio" value="<?php echo e(old('precio')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="stock" class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="number" min="0" name="stock" value="<?php echo e(old('stock', 1)); ?>" required />
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="imagen" class="block font-medium text-sm text-gray-700"><?php echo e(__('Imagen del Producto')); ?> <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                ...
                                <select id="ingredientes" name="ingredientes[]" multiple class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 h-48">
                                    <?php $__currentLoopData = $ingredientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingrediente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ingrediente->id); ?>" <?php echo e(in_array($ingrediente->id, old('ingredientes', [])) ? 'selected' : ''); ?>>
...
<?php endif; ?>
    <?php /**PATH E:\Proyecto de Grado\Laravel\pro-grado-app-final\resources\views\admin\productos\create.blade.php ENDPATH**/ ?>
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- ENLACES A TUS CRUDs (Solo visibles para admins) --}}
                    ...
                    @can('viewAny', App\Models\Ingrediente::class)
                        <x-nav-link :href="route('ingredientes.index')" :active="request()->routeIs('ingredientes.*')">
                            {{ __('Ingredientes') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- ENLACES A TUS CRUDs (RESPONSIVE) (Solo visibles para admins) --}}
            @can('viewAny', App\Models\Role::class)
            ...
            @can('viewAny', App\Models\Ingrediente::class)
                <x-responsive-nav-link :href="route('ingredientes.index')" :active="request()->routeIs('ingredientes.*')">
                    {{ __('Ingredientes') }}
                </x-responsive-nav-link>
            @endcan
        </div>

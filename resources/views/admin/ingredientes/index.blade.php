            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-2xl font-bold mb-6 text-chamos-marron-oscuro">{{ __('Lista de Ingredientes') }}</h3>
                        ...
                        @if ($ingredientes->isEmpty())
                            <p class="text-gray-600">{{ __('No hay ingredientes registrados en el sistema.') }}</p>
                        @else
